...
class Module{
  function home($user_id){
    ...
    //Mencari Harga Cocok
      if(isset($Fx[1]) AND isset($Fx[2]) AND isset($Fx[3])){
    ...
    //Tampilkan Daftar
      if(isset($resultPrice)){
        ...
        $query = "SELECT A.*,
                  ...
                  FROM tbl_rumah A
                  LEFT JOIN tbl_rating AA ON A.rumah_id=AA.rumah_id AND AA.user_id=$user_id
                  ...
                  WHERE (harga * 20 / 100)<='$resultPrice'
